...
<div class="body">
	<div class="row">
		...
		<table class="lliisstt">
			...
			<c:forEach items="${uproductList}" var="productVO">
				<tr>
				...
				<tr align="center">
					...
					<td colspan="3" align="center" style="border: 1px solid black; border-radius: 10px;">
						<div class="box-body">
							<select id="searchType" name="searchType" style="height: 30px; width: 100px; background-color: #f2f2f2; text-align: center;">
								<option value="all"
